		...
		<PageHOC>
			...
			>
				<div className="bg-[#44414B] p-5 w-[25%] mb-5 text-white text-center text-2xl rounded-lg">
					Start your Project <span className="ml-4">🚀</span>
				</div>
				<div className="w-full flex gap-10 justify-between items-center my-5">
					<InputContainer
						...
						required
						placeholder="Something like 'Awesome Rollercoster'"
				...
				<div className="w-full flex gap-10 justify-between items-center my-5">
					<InputContainer
						...
						title="Goal"
						required
						placeholder="Solana you are aiming for."
						onChange={(e: any) =>
							updateProject({ goal: new BN(e.target.value) })
						}
					/>
					<div className="flex flex-col items-start w-full">
						<h5 className={`text-[#69676F] mb-2`}>Deadline</h5>
						<input
				...
				<div className="w-full flex items-center gap-5 my-5 rounded-md bg-[#8D6DEB] py-5 px-5">
					...
					<h1 className="text-white font-semibold text-xl">
						You will get 💯 percent of the money raised.
					</h1>
				</div>
