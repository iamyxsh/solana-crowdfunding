				...
				<div className="flex flex-row justify-between items-start gap-5">
					<div className="flex flex-col gap-5 w-[70%]">
						...
						<div
							className={`bg-[${COLORS.secondaryBg}] rounded-lg p-5 flex flex-col gap-3`}
						>
							<h1 className="text-white text-lg">Donators</h1>
						...
						>
							<h1 className="text-white text-start w-full text-lg">Fund</h1>
							...
							<div className="w-full flex flex-col items-start gap-2 my-5 rounded-md bg-[#8D6DEB] py-5 px-5">
								<h1 className="text-white">Back it if you believe in it.</h1>
					...
					<div className="w-[20%] flex flex-col gap-5">
						<div
							className={`bg-[${COLORS.secondaryBg}] rounded-lg p-5 flex flex-col gap-3`}
						>
							<h1 className="text-white text-lg">Deadline</h1>
							<p className={`text-md text-[#59CF9A]`}>
								{
									new Date(
										currentProject
						...
						<div
							className={`bg-[${COLORS.secondaryBg}] rounded-lg p-5 flex flex-col gap-3`}
						>
							<h1 className="text-white text-lg">Goal</h1>
							<p className={`text-md text-[#59CF9A]`}>
								{currentProject &&
						...
						<div
							className={`bg-[${COLORS.secondaryBg}] rounded-lg p-5 flex flex-col gap-3`}
						>
							<h1 className="text-white text-sm">Raised</h1>
							<p className={`text-md text-[#59CF9A]`}>
								{currentProject &&
